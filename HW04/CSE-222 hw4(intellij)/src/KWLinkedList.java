...
public class KWLinkedList < E > {
    ...
    /** Add an item at the specified index.
     ...
     @throws IndexOutOfBoundsException if the index is out of range (i  smaller than  0 || i  bigger than  size())
    */
    ...
    /**
     *  verilen index'teki veriyi siler
     *
     * @param index silinecek index
     */
    ...
    /**
     *  simetrik verilerin yerlerini değişir.Listeyi reverse eder   a b | c d    --   d c | b a
     */
    protected void reverse(){

        for (int i=0;i< (int)(size/2);++i){

            E temp = (E) getNode(0+i, head).data;
            getNode(0+i, head).data= getNode(size-1-i, head).data;
            getNode(size-1-i, head).data = temp;
        }
    }

    /**
     *   Get the node recursivly at position index.
     *
     * @param index  istenen node indexi
     * @param node   istenen node
