...
public class BinarySearchTree < E extends Comparable < E >>
    ...
    implements SearchTree < E > ,Iterable{
  // Data Fields
  ...
  /** Recursive find method.
      ...
      @return The object, if found, otherwise null
   */
  private Node<E> findHelp(Node < E > localRoot, E target) {
    if (localRoot == null)
      return null;
    ...
    if (compResult == 0)
      ...
      return findHelp(localRoot.left, target);
    else
      return findHelp(localRoot.right, target);
  }
