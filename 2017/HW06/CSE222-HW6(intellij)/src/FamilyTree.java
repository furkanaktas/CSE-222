 ...
 */
public class FamilyTree<E extends Comparable < E >> extends BinaryTree implements Iterable{
     ...
     * @throws IOException hata iletmek için
     * @return bool
     */
     ...
     * @throws UnexpectedException hata iletmek için
     * @return   yeni root
     */
     ...
     */
    public void levelTreverser(FamilyTree tree){
