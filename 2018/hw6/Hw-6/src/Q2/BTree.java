...
public class BTree<E extends Comparable<E>>  implements SearchTree<E> {
     ...
     * @param order - the size of a node
     * @throws IllegalArgumentException if order smaller than 3
     */
...
//----------------------------------------------------------------------------------------------------------------------------------------
    /**
     *
     * @param item that is searching for
     * @param localItems is array that will be looking for
     * @param start is start index for searching
     * @param end is end index for searching
     * @return index of target if found, else return index of place where item will be inserting
     */
    private int binarySearch(E item, E[] localItems,int start , int end){
